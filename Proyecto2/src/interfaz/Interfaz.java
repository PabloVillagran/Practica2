...
public class Interfaz extends JFrame{
	...
	public Interfaz(){
		...
		//Canvas
		canvas.setBounds(5,35,784,635);
		//canvas.setBackground(new Color(0,205,0));
		...
		avanzar.setBounds(470,680,150,50);
		avanzar.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				
			}
		});
		retroceder.setBounds(635,680,150,50);
		avanzar.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
...
class NewCanvas extends Canvas{
	...
	public void paint(Graphics g){
		...
		for(int y =126; y < getHeight();y+=127)	g2d.fillRect(0, y, getWidth(), 10);
